...
namespace Oculus.Interaction
{
    public class Grabbable : PointableElement, IGrabbable
    {
        ...
        /*
         * The following public variables are added by Wei
         * They are used to detect if the object was grabbed or released.
         */
        ...
        private void BeginTransform()
        {
            ...
            // begin the new one
            EndTransform();
            //As soon as the transform begins, the grab action is happening
        ...
        private void EndTransform()
        {
            ...
            _activeTransformer = null;
            // When the transform is ended, the object is released
            IsReleased = true;
        }
